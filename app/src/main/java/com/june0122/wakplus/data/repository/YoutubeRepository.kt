...
class YoutubeRepository @Inject constructor(
    ...
    private suspend fun getYoutubeVideosByPlaylist(idSet: IdSet, profileUrl: String): List<Content> {
        return youtubeApi.run {
    ...
    private fun getYoutubeContent(videoInfo: YoutubeVideoInfo, profileUrl: String) =
        Content(
